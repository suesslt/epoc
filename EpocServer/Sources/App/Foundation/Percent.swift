...
/// Represents a percentage value. Equivalent to `com.jore.datatypes.percent.Percent`.
///
...
public struct Percent: Hashable, Comparable, Codable, CustomStringConvertible, Sendable {
    ...
    /// The percentage as a BigDecimal (e.g. 10.0 for 10%).
    public var toBigDecimal: Decimal {
