...
/// Represents a year and month combination, equivalent to Java's `java.time.YearMonth`.
/// Immutable value type used throughout the simulation for monthly time steps.
public struct YearMonth: Hashable, Comparable, Codable, CustomStringConvertible, Sendable {
    ...
    /// Factory method matching Java's `YearMonth.of(year, month)`
    ...
    /// Returns the first day of this month as a LocalDate (Date).
